...
namespace Solution.Server.Migrations
{
    ...
    [Migration("20210611145243_userupdate1")]
            ...
            modelBuilder.Entity("Solution.Shared.Roles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2021, 6, 11, 16, 52, 43, 86, DateTimeKind.Local).AddTicks(451),
                            DescriptionType = "Admin",
                            Updated = new DateTime(2021, 6, 11, 16, 52, 43, 86, DateTimeKind.Local).AddTicks(9432)
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2021, 6, 11, 16, 52, 43, 88, DateTimeKind.Local).AddTicks(367),
                            DescriptionType = "Manager",
                            Updated = new DateTime(2021, 6, 11, 16, 52, 43, 88, DateTimeKind.Local).AddTicks(373)
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2021, 6, 11, 16, 52, 43, 88, DateTimeKind.Local).AddTicks(462),
                            DescriptionType = "Artist",
                            Updated = new DateTime(2021, 6, 11, 16, 52, 43, 88, DateTimeKind.Local).AddTicks(463)
                        });
                });
